...
public class WebOSTVServiceSocketClient extends WebSocketClient implements ServiceCommandProcessor {
    ...
    private static final String CHANNEL_NAME = "com.lge.petcarezone/logs";
...
//            manifest.put("localizedAppNames", 1);
    ...
    public void onMessage(String data) {
        ...
        // onMessage 이벤트에서 Flutter로 메시지를 전송
        if (methodChannel != null) {
            new Handler(Looper.getMainLooper()).post(() -> {
                methodChannel.invokeMethod("onMessage", data);
            });
        }
    }
